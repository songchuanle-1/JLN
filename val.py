...
from lib.helpers.valer_helper import Tester
from lib.helpers.utils_helper import create_logger
from lib.helpers.utils_helper import set_random_seed


parser = argparse.ArgumentParser(description='Mono3DVG Transformer for Monocular 3D Visual Grounding')
parser.add_argument('--config', default='/sdc1/songcl/mono3D/Mono3DVG/configs_com_params/aaa_three_add_injection_all4.yaml', help='settings of detection in yaml format')
# /sdc1/songcl/mono3D/Mono3DVG/configs_com_params/aaa_three_add_injection_all4.yaml
# /sdc1/songcl/mono3D/Mono3DVG/configs_com_params/mono3dvg_author.yaml
