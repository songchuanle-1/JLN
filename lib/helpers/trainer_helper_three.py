...
class Trainer(object):
    def __init__(self,
        ...
        # print(cfg['pretrain_model'] == None)
        # loading pretrain/resume model
        if cfg.get('pretrain_model',None):
    ...
    def train_one_epoch(self, epoch):
        ...
        for batch_idx, (inputs, calibs, targets, info) in enumerate(self.train_loader):
            ...
            # target_visual_classifier = targets['target_visual_classifier']
            targets = self.prepare_targets(targets, inputs.shape[0])
            # targets['target_visual_classifier'] = target_visual_classifier
            # train one batch
            ...
            if batch_idx % 30 == 0:
                print_str = 'Epoch: [{}][{}/{}]\t' \
                    ...
                    mono3dvg_losses_dict_log['loss_adapt'],\
                    mono3dvg_losses_dict_log['loss_adapt_depth'],\
                    mono3dvg_losses_dict_log['contrastive_learning'],\
                    )
